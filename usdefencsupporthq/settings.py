"""
Django settings for usdefencsupporthq project.
...
ALLOWED_HOSTS = [
    'usdefencsupporthq.org',
    'www.usdefencsupporthq.org',
]
...
ROOT_URLCONF = 'usdefencsupporthq.urls'
...
WSGI_APPLICATION = 'usdefencsupporthq.wsgi.application'
